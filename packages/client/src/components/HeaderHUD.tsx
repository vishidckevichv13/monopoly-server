...
import { Timer, LogOut, AlertTriangle, Coins, Eye } from 'lucide-react';
...
export const HeaderHUD: React.FC<HeaderHUDProps> = ({
  ...
  return (
    <>
      <div className="w-full bg-slate-900/95 backdrop-blur-2xl border-b-2 border-slate-700/70 px-3 pb-2.5 pt-[max(var(--safe-top),12px)] z-30 shadow-2xl shrink-0">
